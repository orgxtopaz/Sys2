...
function ViewSpecificTotalAttendance() {
  ...
  useEffect(() => {
    if (isLoaded) {
      Axios.post(`http://localhost:5000/viewSpecificTotalAttendance/${userId}`,{
  ...
  const [requestTo , setRequestTo] = useState("");
    ...
    const request = () => {
      ...
      function saveUpdate() {
        ...
        Axios.post(`http://localhost:5000/salaryRequest`,
     ...
     <div className="container" style={{top:"330px",height:"395px"}}>
          ...
          <div className="text-container" style={{left:"230px"}}>
            ...
            <select
                ...
                placeholder="sdsd"
                style={{ borderColor: "black" ,height:"32px",fontFamily:"'Raleway', sans-serif",width:"190%"}}
              >
                <option value="" hidden>
                  Request to
                </option>
                <option value="sk" style={{fontFamily:"'Raleway', sans-serif"}}>Admin</option>
            ...
            <button type="submit"  onClick={request} className="btn " style={{backgroundColor:"red",color:"white"}} >
